...
import final from "../../../assets/vii.mp4";
      ...
      <div className="w-[100vw]  top-0  h-[40vh] md:min-h-screen ">
        ...
        <div className="w-[100%]  h-[100%] flex flex-col items-center justify-center gap-4 mb-5">
          <div className="w-[256px] h-[71px] md:w-[554px] text-white md:h-[141px] font-benderregular md:text-[70px] text-[32px] font-bold leading-none text-center">
            Welcome to <span className="text-[#13FBD3]">iGen</span>
          </div>
          <p className="w-[303px] hidden md:block md:w-[699px] md:mb-10 md:h-[50px] font-benderlight h-[54px] text-center text-[14px] md:text-[16px] font-normal">
            Step into the vibrant realm of iGen Community, where enthusiasm
            ignites purpose and creativity thrives. Led by the torchbearers of
            tomorrow, we're not just another community; we're the architects of
            a tech revolution. Join us as we sculpt the future of innovation and
            empower the next wave of trailblazers. Welcome to our playground of
            ideas, where every voice echoes with the promise of progress. Strap
            in, adventurer, for here, dreams take flight!{" "}
          </p>
