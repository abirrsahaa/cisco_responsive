    ...
    <>
      <div className="w-[100vw]  h-[80vh] flex flex-col justify-center items-center bg-[#09131D]">
        <motion.div
          ...
          className="w-[210px] font-benderregular h-[34px] mb-5 md:w-[314px]  md:h-[54px] md:text-[48px] text-[32px]  flex  items-center justify-center font-bold text-[#13FBD3] rounded-lg"
        >
          Testimonials
        </motion.div>
        <div className="w-[85%] transition-all ease-in duration-300  h-[80%] md:hidden rounded-xl overflow-hidden m-1 flex flex-col items-center justify-center bg-[#121E2C] shadow-xl mb-3">
          <div className="w-[100%] h-[60%]   flex justify-center items-center">
            <div className="w-[80%] font-benderregular  relative h-[95%] overflow-hidden rounded-xl ">
              <div className="w-[100%] font-benderregular p-2 flex flex-col  items-start justify-center h-[25%] bg-black bottom-0 absolute opacity-[0.6] ">
          ...
          <div className="w-[95%] font-benderregular relative h-[40%] rounded-xl flex items-center justify-center ">
        ...
        <div className="w-[70%] relative   h-[70%] hidden  rounded-xl overflow-hidden m-1 md:flex  items-center justify-center bg-[#121E2C]">
          <div className="w-[80%] h-[80%]  flex justify-center items-center">
            ...
            <div className="w-[65%] font-benderregular h-[100%] rounded-lg ml-5">
