  ...
  return (
    <>
      <div className="w-[100vw]  h-[80vh] flex flex-col justify-center items-center">
        ...
        <div className="w-[85%]  h-[80%] md:hidden rounded-xl overflow-hidden m-1 flex flex-col items-center justify-center bg-gray-600 mb-3">
          <div className="w-[100%] h-[70%]  flex justify-center items-center">
            <div className="w-[80%] relative h-[95%] overflow-hidden rounded-xl ">
              <div className="w-[100%] p-2 flex flex-col gap-2 items-start justify-center h-[25%] bg-black bottom-0 absolute opacity-[0.4]">
                <div className="text-green-500 font-bold text-xl text-left">
                  Name
                </div>
